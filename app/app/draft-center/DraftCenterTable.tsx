  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-3">
        {prospects.length} prospects · rang moyen calculé sur {DRAFT_SOURCES_RANKED.length} sources · CS-NA et CS-EU à titre informatif · cliquer un joueur pour voir ses statistiques
      </p>
